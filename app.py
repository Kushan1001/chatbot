...
#------------------------------------------------------------------------------------
    def handle_musical_instruments(parsed_url, page, nid, language):
        ...
        try:
            ...
            base_url = 'https://icvtestingold.nvli.in/rest-v1/musical-instruments'
...
#------------------------------------------------------------------------------------
    def handle_snippets(parsed_url, page, nid, language):
        try:
            ...
            for p in pages_to_try:
                api_url = f'https://icvtestingold.nvli.in/rest-v1/snippets?page={p}&&field_state_name_value='
                data = extract_page_content(api_url)
    ...
    def handle_textiles(parsed_url, page, nid, language):
        ...
        try:
            ...
            if subcategory_type == 'artisans':
                ...
                api_url = f'https://icvtestingold.nvli.in/rest-v1/INDIGO-DYE-AND-REVOLT?page={page if page != "" else 0}'
                print('api_url', api_url)
                ...
                api_url = f'https://icvtestingold.nvli.in/rest-v1/textiles-and-fabrics-of-india/type-of-textile/{section}?page=0&&field_state_name_value='
                subcategory_data = []
        ...
        try:
            ...
            if category == 'north-east-india':
                ...
                if sub_category == 'capital-cities-north-east-india':
                    ...
                    api_url = f'https://icvtestingold.nvli.in/rest-v1/tales-from-the-hinterland?page={page if page != "" else 0}&&field_state_name_value='
            ...
            if category == 'east-india':
                if sub_category == 'bihar':
                    ...
                    if section == 'digital-archives':
                        ...
                        api_url  = 'https://icvtestingold.nvli.in/rest-v1/states-of-india/bihar/freedom-archive?page=0&&field_state_name_value='
...
#-----------------------------------------------------------------------------
    ...
    def handle_historical_cities(parsed_url, page, nid, language):
        try:
            ...
            api_url = f'https://icvtestingold.nvli.in/rest-v1/historic-cities?page=0&&field_state_name_value='
            print('api_url',api_url)
            data = extract_page_content(api_url)
            if not data or 'results' not in data:
                return jsonify({"summary": "No data found"}), 404
